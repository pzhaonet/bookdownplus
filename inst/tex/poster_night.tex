...
\definecolor{kuldark}{rgb}{0.25, 0.25, 0.28}   % heading background peng
\definecolor{kulbgleft}{rgb}{0.7, 0.75, 0.71} % background fill gradient left
\definecolor{kulbgright}{rgb}{0.7, 0.75, 0.71} % background fill gradient right
\definecolor{kulheaderleft}{rgb}{0.25, 0.25, 0.28} % header fill gradient left
\definecolor{kulheaderright}{rgb}{0.25, 0.25, 0.28} % header fill gradient right
