...
The R package [`bookdownplus`](https://cran.r-project.org/web/packages/bookdownplus) [@R-bookdownplus] is an extension of `bookdown` [@R-bookdown1]. It is a collection of
