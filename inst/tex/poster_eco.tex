...
\definecolor{kuldark}{rgb}{0.0, 0.5, 0.0}   % heading background peng
\definecolor{kulbgleft}{rgb}{0.94, 1.0, 1.0} % background fill gradient left
\definecolor{kulbgright}{rgb}{0.94, 1.0, 1.0} % background fill gradient right
\definecolor{kulheaderleft}{rgb}{0.0, 0.5, 0.0} % header fill gradient left
\definecolor{kulheaderright}{rgb}{0.0, 0.5, 0.0} % header fill gradient right
